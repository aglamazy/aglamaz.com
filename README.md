...
| [`agents-billing`](./agents-billing) | `26.6.1` | Aglamazo-signal receiver for horizontals. Accepts Aglamazo's signed paid-period webhook, verifies HMAC signature, and calls `setPeriodAllowance` (agents-quota) to fund the quota for the period. Aglamazo owns Ypay creds + clearance + ledger. | [aglamazy/agents-billing](https://github.com/aglamazy/agents-billing) |
