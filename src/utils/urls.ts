...
export const routePaths: Record<AppRoute, string> = {
  ...
  [AppRoute.ADMIN_LOGIN_AUDIT]: '/admin/login-audit',
};
...
export const apiRoutePaths: Record<ApiRoute, string> = {
  ...
  [ApiRoute.SITE_ANNIVERSARY_PHOTO]: '/api/site/{siteId}/anniversaries/{anniversaryId}/photo',
  ...
  [ApiRoute.SITE_EMAIL_TRACKING_DETAIL]: '/api/site/{siteId}/email-tracking-summary/detail',
