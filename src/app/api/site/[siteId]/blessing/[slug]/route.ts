...
import { getBlessingPageRepoOverride, getAnniversaryRepoOverride } from './testOverrides';
...
export async function GET(
  ...
  try {
    ...
    const blessingPageRepo = getBlessingPageRepoOverride() ?? new BlessingPageRepository();
    ...
    const anniversaryRepo = getAnniversaryRepoOverride() ?? new AnniversaryRepository();
