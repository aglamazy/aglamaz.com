    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1
            className="text-2xl font-bold text-gray-900 text-center">{t('welcomeToFamilyCircle', { name: siteInfo?.name || 'FamilyCircle' })}</h1>
        ...
        <div className="w-full mb-3">
          ...
          <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path
        ...
        <div className="w-full mb-6">
          <label className="block text-gray-700 text-sm mb-1" htmlFor="password">{t('password')}</label>
          <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path
                  d="M17 11V7A5 5 0 0 0 7 7v4M5 11h14v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7Z" strokeLinecap="round"
